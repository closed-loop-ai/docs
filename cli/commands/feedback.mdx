...
The `cl insights` command displays AI-generated insights from your ingested customer data. These insights are automatically created by ClosedLoop AI's analysis engine, providing structured, actionable intelligence from raw customer input.
...
cl insights 2ea8f556-052b-4f5c-bf86-833780b3d00d

# JSON output
cl insights 2ea8f556-052b-4f5c-bf86-833780b3d00d --json
```
