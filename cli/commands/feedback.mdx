...
The `cl feedback` command displays AI-generated insights from your ingested customer data. These insights are automatically created by ClosedLoop AI's analysis engine, providing structured, actionable intelligence from raw customer input.
